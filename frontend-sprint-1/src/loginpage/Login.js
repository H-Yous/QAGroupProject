...
import InputValidator from '../components/validation/InputValidator.js';
import validatedComponent from '../components/validation/ValidatedComponent.js';
    ...
    render() {
      ...
      return (
        <div className="ba-login row">
          <form noValidate>
            <div className="panel small-20 small-centered columns">
