...
class ControlledCarousel extends React.Component {
  componentDidMount() {
    ...
    axios
      .get("http://localhost:8080/api/getNowShowingMovies")
  ...
  render() {
    ...
    return (
      <Styles>
        ...
        >
          <Carousel.Item>
            <img id="poster1" className="d-block w-100" alt="First slide" />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img id="poster2" className="d-block w-100" alt="Third slide" />
          ...
          <Carousel.Item>
            <img id="poster3" className="d-block w-100" alt="Third slide" />
          ...
          <Carousel.Item>
            <img id="poster4" className="d-block w-100" alt="Third slide" />
          ...
          <Carousel.Item>
            <img id="poster5" className="d-block w-100" alt="Third slide" />
